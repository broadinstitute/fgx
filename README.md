...
| [`nb08_genetics_primer.py`](notebooks/nb08_genetics_primer.py) | Educational walkthrough from GWAS and fine-mapping through colocalization, exome results, molecular QTLs, and gene-disease curation | [![Open in molab](https://marimo.io/molab-shield.svg)](https://molab.marimo.io/github/broadinstitute/fgx/blob/main/notebooks/nb08_genetics_primer.py) |
| [`nb09_polygenic_heart_disease.py`](notebooks/nb09_polygenic_heart_disease.py) | Polygenic coronary heart disease: locus landscape, effect sizes, colocalization, pathways, and exome evidence | [![Open in molab](https://marimo.io/molab-shield.svg)](https://molab.marimo.io/github/broadinstitute/fgx/blob/main/notebooks/nb09_polygenic_heart_disease.py) |
| [`nb10_diabetes_susceptibility.py`](notebooks/nb10_diabetes_susceptibility.py) | Type 2 diabetes susceptibility: locus landscape, effect sizes, TCF7L2 colocalization, and MODY gene curation | [![Open in molab](https://marimo.io/molab-shield.svg)](https://molab.marimo.io/github/broadinstitute/fgx/blob/main/notebooks/nb10_diabetes_susceptibility.py) |
| [`nb11_protective_cancer_variants.py`](notebooks/nb11_protective_cancer_variants.py) | Protective cancer variants across resources, with locus clustering and PheWAS classification of clean protection versus disease trade-offs | [![Open in molab](https://marimo.io/molab-shield.svg)](https://molab.marimo.io/github/broadinstitute/fgx/blob/main/notebooks/nb11_protective_cancer_variants.py) |
